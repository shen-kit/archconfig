...
function _M.get()
  ...
  -- awesome
    ...
    awful.key({ modkey }, "b", function() awful.spawn(browserPersonal) end,
      { description = "brave browser (personal profile)", group = "launch applications" }),
    awful.key({ modkey, 'Shift' }, "b", function() awful.spawn(browserUni) end,
      { description = "brave browser (uni profile)", group = "launch applications" }),
    awful.key({ modkey, altkey }, "b", function() awful.spawn(browserWork) end,
      { description = "brave browser (work profile)", group = "launch applications" }),
    awful.key({ modkey }, "n", function() awful.spawn("obsidian") end,
    ...
    awful.key({ "Control" }, "Print", function()
      ...
      { description = "full screenshot to file", group = "utilities" }),
